...
import { financeDashboardData } from "@/lib/mock-data/finance-dashboard";
import { findBoardById, organization } from "@/lib/mock-data/organization";

interface FinanceKPIDashboardProps {
  className?: string;
}

export function FinanceKPIDashboard({ className }: FinanceKPIDashboardProps) {
...
export { KPIBubble } from "./KPIBubble";
export { SubBoardCard } from "./SubBoardCard";
